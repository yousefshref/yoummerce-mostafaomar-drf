...
class OrderAdmin(admin.ModelAdmin):
    ...
    fields = ('user', 'name', 'address', 'phone', 'state', 'shipping', 'is_arrived', 'total_order', 'total_earning', 'total_commission',)
    ...
    def get_fields(self, request, obj=None):
        if not request.user.is_superuser:
            self.fields = ('user', 'name', 'address', 'phone', 'state', 'shipping', 'is_arrived', 'total_order', 'total_commission',)
        return super().get_fields(request, obj)
